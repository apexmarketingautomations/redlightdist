...
export function CreatorShell({
  ...
  return (
    <main className="office creator-office">
      <header className="office-header">
        <a className="office-brand" href="/dashboard">
          REDLIGHT <span>CREATOR</span>
        </a>
        <div className="office-header-actions">
          <span className="office-badge">{plan}</span>
          {admin && (
            <a
              className="office-button quiet"
              href={`/admin/clients/${creatorId}`}
            >
              Admin controls
            </a>
          )}
      ...
      <div className="creator-console-layout">
        <aside className="creator-sidebar">
          <div className="creator-sidebar-title">
