...
export type TipInput = PurchaseInput;
...
export class PaymentProviderCapabilityError extends Error {
  constructor(provider: string, operation: string) {
    super(
      `${provider} does not have ${operation} configured for this deployment.`,
    );
...
export function hasPaymentProvider(name: string): boolean {
